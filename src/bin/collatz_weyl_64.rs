//! Command-line front-end for [`CollatzWeyl64`].
//!
//! Usage:
//!
//! ```text
//! collatz_weyl_64 <seed> [count]
//! ```
//!
...
use std::io::Write;
use collatz_weyl::CollatzWeyl64;
use std::process::ExitCode;

const PROG: &str = "collatz_weyl_64";
...
fn main() -> ExitCode {
    ...
    let mut rng = CollatzWeyl64::new(seed);
